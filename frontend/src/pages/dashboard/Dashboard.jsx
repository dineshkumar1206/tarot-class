...
import { Play, PlayCircle, FileText, Download, Eye, Clock, BookOpen } from 'lucide-react';
...
const Dashboard = () => {
  ...
  // Set initial active video once loaded
  React.useEffect(() => {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-amber-500/30">
      ...
      <main className="pb-24">
        ...
        <section id="video-lessons" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20">
            ...
            <div className="flex-1 bg-black p-0 relative group">
              {activeVideo ? (
                <div className="aspect-video relative">
                  <video 
                    key={activeVideo.id} // forces reload when src changes
                    controls 
                    controlsList="nodownload"
                    onContextMenu={(e) => e.preventDefault()}
                    className="w-full h-full object-contain bg-black"
                    poster={`https://picsum.photos/seed/${activeVideo.id}/1280/720`}
                  >
        ...
        <section id="study-guides" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20">
